 ...
 */
public class AbstractReversiView extends JFrame implements ReversiView {
   ...
   */
  public AbstractReversiView(ROModel model, TokenColor frameTokenColor) throws HeadlessException {
